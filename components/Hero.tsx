...
export function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050810] px-3 sm:px-6 lg:px-8">
      {/* Animated Background */}
      ...
      <m.div 
        className="relative z-10 w-full max-w-[1200px] mx-auto py-12 sm:py-20 lg:py-24 text-center"
      ...
      >
        ...
        <m.h1
          ...
          className="text-2xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-3 sm:mb-6 tracking-tight px-2"
        >
        ...
        <m.p
          ...
          className="text-lg sm:text-2xl md:text-3xl mb-2 sm:mb-4 font-light px-4"
        >
        ...
        <m.p
          ...
          className="text-xs sm:text-base lg:text-lg text-white/60 mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-4"
        >
        ...
        >
          <Link href="/register" className="w-full sm:w-auto">
            <m.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full sm:w-auto group relative px-5 sm:px-8 py-2.5 sm:py-4 font-semibold rounded-xl overflow-hidden transition-all duration-300 text-sm sm:text-base"
              style={{
            ...
            >
              <m.span 
                className="relative z-10 flex items-center justify-center gap-1.5 sm:gap-2 text-[#050810]"
                whileHover={{ x: 5 }}
          ...
          <Link href="/themes" className="w-full sm:w-auto">
            <m.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full sm:w-auto group relative px-5 sm:px-8 py-2.5 sm:py-4 border-2 border-[#00ff88]/50 text-white font-semibold rounded-xl overflow-hidden transition-all duration-300 text-sm sm:text-base"
            >
              <m.span 
