export const eventConfig = {
  ...
  date: process.env.EVENT_DATE || "2026-04-01",
  venue: process.env.EVENT_VENUE || "JJ College of Engineering and Technology (Autonomous) Campus, Trichy",
  registrationDeadline: process.env.REGISTRATION_DEADLINE || "2026-03-27",
  shortlistDate: "2026-03-28",
  paymentDeadline: "2026-03-29",
  
  isPostponed: false,
  postponeMessage: "Registrations are open! Don't miss this opportunity to participate.",
  showDateAsTBA: false,
  showDeadlineAsTBA: false,
  ...
  contact: {
    ...
    studentCoordinator: {
      name: "Mr P Ayyappan B.E CSE II Year",
      phone: "9042143286",
