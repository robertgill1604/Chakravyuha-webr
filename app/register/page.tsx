      ...
      <section className="py-12 bg-[#0B1220]">
        <div className="max-w-[760px] mx-auto px-6 lg:px-8">
          <m.div
            ...
            className="relative p-8 md:p-10 rounded-2xl bg-gradient-to-br from-[#111827]/90 to-[#0B1220]/90 backdrop-blur-xl border border-white/[0.06] overflow-hidden"
          >
            {/* Glow Effect */}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm">
                    <span className="text-white/80">
                      <span className="text-white/50">Student Coordinator:</span> {eventConfig.contact.studentCoordinator.name}
                    </span>
                    <span className="text-[#22D3EE]">{eventConfig.contact.studentCoordinator.phone}</span>
                  </div>
                </div>
              </div>
            </div>
